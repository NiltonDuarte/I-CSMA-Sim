...
fileNamesIdx = (30,40)#(20,30)#(10,20)#(0,10)#(10,20)
...
resultsSaveFile = saveResultsFilePath+"gitignoreR"+str(fileNamesIdx)+".csv"
for name in fileNames:
  for nameIdx in range(*fileNamesIdx):
    ...
    interfGraph = InterferenceGraph(netGraph, InterfDist, False, delayT)
        ...
        for beta in betaList:
          for r in rho:
            for delayT in delayList:
              ...
              if algorithm == "ICSMA":
                maa = MultipleAccessAlgorithm(interfGraph, beta, 252+28,r, arrivalMean, False, True, delayT) 
                ...
                maa = MultipleAccessAlgorithm(interfGraph, beta, 252+16,r, arrivalMean, False, True, delayT)     
                maa.turnOnFunctions(False,True,'sech',False)
  ...
  #===================== MODELO DE ISING com CAMPO EXTERNO ===================================
                ...
                arrivalMean, numMaxSched, arrivalSum = getArrivalVectorDict(maxSchedPath+maxSchedFileName+name+str(nameIdx)+".csv")
                maa = MultipleAccessAlgorithm(interfGraph, beta, 252+36,r, arrivalMean, False, True, delayT) 
                maa.g= gamma
                maa.turnOnFunctions('base10',True,'placeholder',False)
  ...
  #===================== UNVEN TRAFFIC MODELO DE ISING com CAMPO EXTERNO ===================================   
              ...
              results=", ".join(str(x) for x in ([round(queue/n,2), r, algorithm, name+str(nameIdx), beta, gamma, delayT ,arrivalSum, numEdges, numMaxSched, testesIt] + queuesList + maa.schedSizeFrequency))
